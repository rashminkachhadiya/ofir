                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group col-md-12">
                                       ...
                                       <input type="text" class="form-control" id="gram" name="gram" value="" placeholder="" >
                                        <span id="error_gram" class="has-error"></span>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for=""> Ct </label>
                                       <input type="number" class="form-control" id="ct" name="ct" value="" placeholder="" >
                                        <span id="error_ct" class="has-error"></span>
                                    </div>
                                    <div class="form-group col-md-12">
                                        <label for=""> Quantity </label>
                                       <input type="number" class="form-control" id="quantity" name="quantity" value="" placeholder="" >
