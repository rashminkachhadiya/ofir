                            ...
                            <tr>
                                ...
                                <td width="70%" align="center" valign="top">
                                    <table id="details" width="100%" border="0" cellspacing="1" cellpadding="0">
                                        <tbody>
                                            <tr style="">
                                                <td width="10%" height="25" align="center" bgcolor="" valign="middle" style="border: 1px solid #000;border-bottom: none;border-right: none"><span style="font-size: 12px; color: #000;"><strong>Date</strong></span></td>
                                                <td width="10%" height="25" align="center" bgcolor="" valign="middle" style="border: 1px solid #000;border-bottom: none;border-right: none"><span style="font-size: 12px; color: #000;"><strong>Order</strong></span></td>
                                                ...
                                                <td width="10%" height="25" align="center" bgcolor="" valign="middle" style="border: 1px solid #000;border-bottom: none;border-right: none"><span style="font-size: 12px; color: #000;"><strong>Code</strong></span></td>
                                                <td width="10%" height="25" align="center" bgcolor="" valign="middle" style="border: 1px solid #000;border-bottom: none;border-right: none"><span style="font-size: 12px; color: #000;"><strong>Size</strong></span></td>
                                                <td width="10%" height="25" align="center" bgcolor="" valign="middle" style="border: 1px solid #000;border-bottom: none;border-right: none"><span style="font-size: 12px; color: #000;"><strong>Qty</strong></span></td>
