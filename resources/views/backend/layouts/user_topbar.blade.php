                        ...
                        <div class="widget-content-left">
                            <div class="btn-group">
                                <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"
                                   class="p-0 btn" aria-label="{{ __('User menu') }}">
                                    <img class="rounded-circle" src="{{ asset('assets/images/users/default.png') }}"
                                         alt="{{ Auth::user()->name }}" width="42" height="42">
                                ...
                                <div tabindex="-1" role="menu" aria-hidden="true"
                                    ...
                                    <a class="dropdown-item" href="{{ URL::to('/user/change_password') }}">
                                        <i class="fa fa-lock fa-fw"></i> {{ __('Change Password') }}
                                    </a>
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="{{ URL::to('/user_login/logout') }}">
